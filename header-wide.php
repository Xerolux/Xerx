<?php
/**
 * Wide header for portfolio/showcase pages.
 *
 * @package xerx
 */
?>
...
<div id="page" class="page-shell">
	...
	<header class="site-header" role="banner">
		<div class="site-header__inner">
			...
			<nav class="site-header__nav" role="navigation" aria-label="<?php esc_attr_e( 'Primary navigation', 'xerx' ); ?>">
				<?php
				wp_nav_menu(
					array(
	...
	<div class="search-overlay" id="search-overlay" role="dialog" aria-label="<?php esc_attr_e( 'Search', 'xerx' ); ?>">
		<form class="search-overlay__box" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			<input class="search-overlay__input" type="search" name="s" placeholder="<?php esc_attr_e( 'Search articles, topics, tags\u2026', 'xerx' ); ?>" autocomplete="off" value="<?php echo get_search_query(); ?>">
			<div class="search-overlay__hint">
				<kbd class="search-overlay__kbd">Esc</kbd>
				<span><?php esc_html_e( 'to close', 'xerx' ); ?></span>
				<span style="margin-left: auto;"></span>
				<kbd class="search-overlay__kbd">Ctrl+K</kbd>
	...
	<div id="content" class="main-wrap" style="max-width: var(--measure-lg);" role="main">
